...
ngx_http_v3_send_response(ngx_http_request_t *r)
{
    ...
    ngx_log_debug(NGX_LOG_DEBUG_HTTP, r->connection->log, 0,
                   "quiche_h3_send_response http3 send response stream %ui", r->qstream->id);
...
//    int my_depend_id = r->qstream->id;
    ...
    ngx_log_debug(NGX_LOG_DEBUG_HTTP, stream->connection->connection->log, 0,
                   "quiche_h3_send_body http3 stream written %z bytes on stream %ui", n, r->qstream->id);
