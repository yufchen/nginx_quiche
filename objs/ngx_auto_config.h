#define NGX_CONFIGURE " --build=quiche-b70f728a --with-http_ssl_module --with-http_v2_module --with-http_v3_module --with-openssl=../quiche/quiche/deps/boringssl --with-quiche=../quiche --with-debug"
...
#ifndef NGX_BUILD
#define NGX_BUILD  "quiche-b70f728a"
#endif
